...
# figure out which bingo board won first
def run_game(boards: list, numbers: list) -> list:
    picked_numbers_so_far = []
    for n in numbers:
        picked_numbers_so_far.append(n)
        for board in boards:
...
winning_board, numbers_so_far = run_game(bingo_boards, all_picked_numbers)

score = get_board_score(winning_board, numbers_so_far)
print(score)
